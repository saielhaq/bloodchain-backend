...
public class DonationEditResponse {
...
public DonationEditResponse() {
}

public DonationEditResponse(Integer id, EDonationTypes donationType, Integer quantity, Date donationDate, EDonationStatus donationStatus,
        String userCin) {
    this.id = id;
